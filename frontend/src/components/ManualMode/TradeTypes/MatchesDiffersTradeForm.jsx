...
const MatchesDiffersTradeForm = ({ onPlaceTrade, loading }) => {
        ...
        <div className="radio-group">
          <label>
            <input
              ...
              name="prediction"
              value="matches"
              checked={formData.prediction === 'matches'}
          ...
          <label>
            <input
              ...
              name="prediction"
              value="differs"
              checked={formData.prediction === 'differs'}
              onChange={handleChange}
            />
            ❌ Differs
          </label>
...
export default MatchesDiffersTradeForm;